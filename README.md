...
## 1b. Giao diện (SkoolDownloader.cmd) — cách dùng chính

Double-click **`SkoolDownloader.cmd`** → mở app cửa sổ. Lần đầu trên máy mới nó tự cài môi trường rồi mới mở. Màn hình chính là **Dashboard** (toàn kho khóa); wizard tải / trình quản lý chương-bài vẫn dùng như trước.
